...
export const Description = () => {
  ...
  return (
    <div className='bg-linear-to-r from-[#FF9933] to-[#138808]'>
        <div className='w-full h-[50vh] md:h-[65vh] lg:h-screen bg-cover bg-center flex relative' style={{backgroundImage:`url(${state.image})`}}>
          <Navbar/>
          <div className='text-center -rotate-90 z-50 fixed  right-[-8.3rem] top-[30%]'>
        <Link to='/states'>
    ...
    <div className='w-1/3 h-auto bg-red-700 opacity-75 absolute top-[90%] p-4 left-[60%] hidden md:block lg:block'  data-aos='fade-up' data-aos-delay='200'>
    ...
    <div className='absolute top-[78%]  bg-gradient-to-r from-red-800 bg-opacity-75 p-1 ' data-aos='fade-right' data-aos-delay='200'>
    ...
    <div id='description' className='p-4 w-full h-auto bg-linear-to-r from-red-800 to-red-900 text-white mt-4'>
        <div className='md:w-[60%]' data-aos='zoom-in' data-aos-delay='200'>
    ...
    <div className='mt-4'>
        <iframe src={state.map} className='w-full h-70 md:h-90 lg:h-100'></iframe>
    </div>
    {state.nearByAttractions && (
        <h1 className='text-[2rem] text-center mt-2 text-white font-bold md:text-[2.5rem] lg:text-[3rem]'>NearBy Attractions</h1>
    )}
    <div className='p-4 w-full h-auto bg-linear-to-r from-red-800 to-red-900 text-white mt-4' >
        {state.nearByAttractions.map((attraction, index) => (
            <div key={index} className='w-full h-auto mt-4 flex flex-col md:flex-row lg:flex-row' data-aos='fade-up' data-aos-delay='200'>
                ...
                <h1 className='text-xl md:text-3xl lg:text-[2rem] font-bold mb-2'>{attraction.name}</h1>
